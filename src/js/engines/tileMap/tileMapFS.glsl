...
const vec2 BUTTON_TOP = vec2(12.0, 3.0);
const vec2 BUTTON_LEFT = vec2(11.0, 3.0);
const vec2 BUTTON_RIGHT = vec2(9.0, 3.0);
const vec2 BUTTON_BOTTOM = vec2(10.0, 3.0);
