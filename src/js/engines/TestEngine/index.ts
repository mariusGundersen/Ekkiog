...
export default class TestEngine {
  ...
  render(points: PointList, chargeMapTexture: TextureBuffer, expectedResultTexture: TextureBuffer, output: FrameBuffer, sample: number) {
    this.shader.bind();
    ...
    this.shader.uniforms['expectedResultTexture'] = expectedResultTexture.sampler2D(1);
